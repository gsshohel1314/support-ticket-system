...
@section('mainContent')
    <div class="container d-flex flex-column flex-column-fluid">
        @include('includes.back',['route' => route('user.tickets.index'),'title' => $ticket->ticket_id . " - ".$ticket->category->name])
            ...
            <div class="col-sm-12 col-md-8">
                <div class="ms-5 me-5 card p-5 mb-5 mb-xl-8">
                    <div class="card-body rounded py-3 bg-secondary p-5">
                        <div class="mt-5">
                            <img src="{{ asset(@$ticket->sendable->avatar??'assets/media/avatars/blank.png') }}" class="w-50px h-50px" />
                    ...
                    {{-- Start::Ticket replay --}}
                    <form action="{{ route('user.ticket_reply') }}" method="POST" enctype="multipart/form-data">
                        @csrf
